...
public class MandrakeModel<T extends MandrakeEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rhino = partdefinition.addOrReplaceChild("mandrake", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 2.5F));
	...
	public void setupAnim(MandrakeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimationDefenitions.MANDRAKE_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
	...
	private void applyHeadRotation(MandrakeEntity pEntity, float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
